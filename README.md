...
Telegram Mini App для российской сети магазинов электроники и бытовой техники **КИРГУ**.
Frontend-MVP на тестовых данных (моках), без реального бэкенда. Цены в рублях (₽).
...
- Онлайн-оплата (Telegram Payments / российские платёжные системы, оплата картой)
